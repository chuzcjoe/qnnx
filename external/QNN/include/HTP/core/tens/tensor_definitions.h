...
template <typename T>
API_FUNC_EXPORT constexpr const char *code_to_type_name() {
  return "unknown";
}

#define DECLARE_TENSOR_CODE_TO_TYPENAME_STRING(TYPE)      \
  template <>                                             \
  API_FUNC_EXPORT const char *code_to_type_name<TYPE>() { \
    return TensorTypeStruct<TYPE>::name;                  \
  }
...
#define TENSORDEF_MC(NAME, LAYOUTNAME, DTYPE, MCLASS, ENCODENAME)                                 \
  ...
  struct API_EXPORT NAME {                                                                        \
    ...
    using Interface_t =                                                                           \
        std::conditional_t<dtype_traits<DTYPE>::is_quant, ScaleOffsetInterface<element_type>,     \
...
typedef LayoutTensor<Ldefs::Crouton_16_DeepAR4>
    LayoutCrouton_16_DeepAR4;  // [1,1,4,256] interleaved
typedef LayoutTensor<Ldefs::Crouton_16_DeepAR8>
    LayoutCrouton_16_DeepAR8;                                      // [1,1,8,128] interleaved
...
using TypicalTensors =
    std::tuple<PlainFloatTensor, PlainFloatTensor5D, PlainFloat16Tensor, QuantUint8Tensor,
               QuantUint8Tensor5D, QuantInt8Tensor, QuantInt8Tensor5D, QuantUint16Tensor,
               QuantUint16Tensor5D, QuantInt16Tensor, QuantInt32Tensor, Int32Tensor, Int32Tensor5D,
               Int32Tensor6D, QUint8CroutonTensor, QInt8CroutonTensor, QUint8Crouton4x1Tensor,
               QUint8Crouton2x2Tensor, QUint16CroutonTensor, QInt16CroutonTensor,
               QUint16CroutonTensor_AR4, QUint16CroutonTensor_AR8, QInt32CroutonTensor,
               QFloatTensor, QFloatCroutonTensor, Int32CroutonTensor, PlainFloat16Tensor_TCM,
               PlainFloat16Tensor5D, Int64Tensor, QuantInt16Tensor5D, PlainBFloat16Tensor,
               PlainBFloat16Tensor5D, BFloat16CroutonTensor>;
