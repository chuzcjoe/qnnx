...
template <typename T>
inline constexpr bool is_signed_for_dt = std::is_signed<T>::value;

template <>
inline constexpr bool is_signed_for_dt<Float16> = true;
template <>
inline constexpr bool is_signed_for_dt<BFloat16> = true;
}  // namespace hnnx::dtype_private
...
template <>
struct dtype_traits<DType::QUInt8> {
...
template <>
struct dtype_traits<DType::QUInt16> {
...
template <>
struct dtype_traits<DType::QInt16> {
...
template <>
struct dtype_traits<DType::QInt32> {
  typedef NN_INT32_T element_type;
  typedef NN_UINT32_T storage_type;
  static const int element_size = sizeof(element_type);
  static const bool is_quant = true;
...
template <>
struct dtype_traits<DType::QInt8> {
...
template <DType DT>
dtype_info constexpr inline dtype_info_for() {
...
template <>
dtype_info constexpr inline dtype_info_for<DType::UNKNOWN>() {
  return dtype_info{
      0,               // elbytes
      DType::UNKNOWN,  // dtype
      0,               // is_quant
