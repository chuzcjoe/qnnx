...
template <typename T>
constexpr void AddTypeNameSize(size_t &size) {
...
constexpr size_t GetTypeNamesTotalSize() {
  size_t size = 0;
...
template <typename T>
constexpr void AppendTypeName(char *des, size_t &offset, size_t &duplicate, size_t &left) {
  left--;
