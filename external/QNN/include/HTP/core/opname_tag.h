...
class string_tag_t {
  ...
  static inline registry_t &get_stringreg() {
    return globalStringReg ? *globalStringReg : get_stringreg_func();
  }
 ...
 public:
  ...
  API_EXPORT bool operator==(
      std::string const &x) const;  // { return registry_t::unmap_sv(skey)==x;}
  API_EXPORT bool operator==(
      char const *x) const;  //{ return registry_t::unmap_sv(skey)==std::string_view(x);}
  template <class T>
...
inline bool operator==(std::string_view a, string_tag_t const &b) { return b == a; }
inline bool operator==(std::string const &a, string_tag_t const &b) { return b == a; }
inline bool operator==(char const *a, string_tag_t const &b) { return b == a; }
inline bool operator!=(std::string_view a, string_tag_t const &b) { return !(b == a); }
inline bool operator!=(std::string const &a, string_tag_t const &b) { return !(b == a); }
inline bool operator!=(char const *a, string_tag_t const &b) { return !(b == a); }
#endif
...
inline unsigned find_opname_hash(string_tag_t const &nm) { return nm.skey->second & 0xFFFF; }
#endif
...
template <typename T>
bool get_option_value(Options const &ops, hnnx::opname_tag_parm_t optname, T &result);
...
template <>
struct hashmap_traits<hnnx::string_tag_t, true> {
  static constexpr bool valid = true;
};
template <>
struct hashmap_traits<hnnx::string_tag_t, false> {
  static constexpr bool valid = true;
...
template <>
struct findhash<hnnx::string_tag_t> {
