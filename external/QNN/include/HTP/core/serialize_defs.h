...
class DeSerError {
 ...
 public:
  ...
  void register_error(char const *estr) {  // must be a persistent string!
...
void op_serialize_common(Serializer &sctx, Op const *op,
                         std::type_info const *actual_type = nullptr);
