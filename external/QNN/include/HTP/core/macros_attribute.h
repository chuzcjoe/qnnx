...
// Macros to force a function to be inlined, meaning that the function call is replaced with the
...
// Macros to tell the compiler that the function returns an object that is not aliased, that is,
// referenced by any other pointers.
