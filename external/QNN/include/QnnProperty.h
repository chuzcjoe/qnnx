...
/**
 * @brief Property key for determining whether a backend supports
 * QNN_TENSOR_DATA_FORMAT_UBWC_NV124R_Y data format.
 */
...
/**
 * @brief Property key to determine whether a backend supports float block quantization encodings.
 * See QNN_QUANTIZATION_ENCODING_FLOAT_BLOCK.
 */
#define QNN_PROPERTY_TENSOR_SUPPORT_QUANTIZATION_ENCODING_FLOAT_BLOCK \
  (QNN_PROPERTY_GROUP_TENSOR + 27)

/**
 * @brief Property key to determine whether a backend supports bit-width axis scale-offset
 *        mapped quantization encodings. See QNN_QUANTIZATION_ENCODING_BW_AXIS_SCALE_OFFSET_MAPPED.
 */
#define QNN_PROPERTY_TENSOR_SUPPORT_QUANTIZATION_ENCODING_BW_AXIS_SCALE_OFFSET_MAPPED \
  (QNN_PROPERTY_GROUP_TENSOR + 28)
 ...
 */
#define QNN_PROPERTY_TENSOR_SUPPORT_QUANTIZATION_ENCODING_BW_BLOCK_SCALE_OFFSET_MAPPED \
  (QNN_PROPERTY_GROUP_TENSOR + 29)

/**
 * @brief Property key to determine whether a backend supports bit-width block scale-offset
 *        mapped quantization encodings. See
 * QNN_QUANTIZATION_ENCODING_BW_BLOCKWISE_EXPANSION_MAPPED.
 */
#define QNN_PROPERTY_TENSOR_SUPPORT_QUANTIZATION_ENCODING_BW_BLOCKWISE_EXPANSION_MAPPED \
  (QNN_PROPERTY_GROUP_TENSOR + 30)

/**
 * @brief Property key to determine whether a backend supports bit-width float block quantization
 * encodings. See QNN_QUANTIZATION_ENCODING_BW_FLOAT_BLOCK.
 */
#define QNN_PROPERTY_TENSOR_SUPPORT_QUANTIZATION_ENCODING_BW_FLOAT_BLOCK \
  (QNN_PROPERTY_GROUP_TENSOR + 31)
