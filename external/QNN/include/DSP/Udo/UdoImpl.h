 ...
 * @return Error Code
 */
SnpeUdo_ErrorType_t SnpeUdo_createOpFactory(
    SnpeUdo_CoreType_t udoCoreType, void* perFactoryInfrastructure, SnpeUdo_String_t operationType,
    uint32_t numOfStaticParams, SnpeUdo_Param_t* staticParams, SnpeUdo_OpFactory_t* opFactory);

typedef SnpeUdo_ErrorType_t (*SnpeUdo_CreateOpFactoryFunction_t)(SnpeUdo_CoreType_t, void*,
 ...
 *
 * @param[in] opFactory The operation factory to release. Upon success this handle will be
 * invalidated.
 *
 * @return Error Code
 */
...
SnpeUdo_ErrorType_t SnpeUdo_createOperation(SnpeUdo_OpFactory_t opFactory,
                                            void* perOpInfrastructure, uint32_t numOfInputs,
                                            SnpeUdo_TensorParam_t* inputs, uint32_t numOfOutputs,
                                            SnpeUdo_TensorParam_t* outputs,
                                            SnpeUdo_Operation_t* operation);

typedef SnpeUdo_ErrorType_t (*SnpeUdo_CreateOperationFunction_t)(SnpeUdo_OpFactory_t, void*,
                                                                 uint32_t, SnpeUdo_TensorParam_t*,
                                                                 uint32_t, SnpeUdo_TensorParam_t*,
                                                                 SnpeUdo_Operation_t*);
 ...
 *
 *        The notification function supports the non-blocking (e.g. asynchronous) execution
 * use-case. In case an "executeUdoOp" function is called with "blocking" set to zero, and a notify
 * function, this function will be called by the implementation library at the end of execution. The
 * implementation library will pass the notify function the ID that was provided to it when
 * "executeUdoOp" was called.
 *
 ...
 *
 *        Calling this function will run the operation on set of inputs, generating a set of
 * outputs. The call can be blocking (synchronous) or non-blocking (asynchronous). To support the
 ...
 *
 */
SnpeUdo_ErrorType_t SnpeUdo_executeOp(SnpeUdo_Operation_t operation, bool blocking,
                                      const uint32_t ID, SnpeUdo_ExternalNotify_t notifyFunc);

typedef SnpeUdo_ErrorType_t (*SnpeUdo_ExecuteOpFunction_t)(SnpeUdo_Operation_t, bool,
                                                           const uint32_t,
 ...
 *
 */
SnpeUdo_ErrorType_t SnpeUdo_setOpIO(SnpeUdo_Operation_t operation, SnpeUdo_TensorParam_t* inputs,
                                    SnpeUdo_TensorParam_t* outputs);

typedef SnpeUdo_ErrorType_t (*SnpeUdo_SetOpIOFunction_t)(SnpeUdo_Operation_t,
