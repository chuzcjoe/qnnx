...
class QnnSampleApp {
 public:
  QnnSampleApp(QnnFunctionPointers qnnFunctionPointers, std::string inputListPaths,
               ...
               ProfilingLevel profilingLevel = ProfilingLevel::OFF, bool dumpOutputs = false,
               std::string cachedBinaryPath = "", std::string saveBinaryName = "",
               unsigned int numInferences = 1, bool serializeProfileLogs = false,
               std::string dlcPath = "");
