...
void noopInvalidParameterHandler(const wchar_t *expression, const wchar_t *function,
...
//    pal::FileOp::open
//-------------------------------------------------------------------------------
int32_t pal::FileOp::open(const std::string &path, pal::FileOp::AccessMode flags,
  ...
  // Create the file
  HANDLE fileHandle = CreateFileA(path.c_str(), dwDesiredAccess, dwShareMode, NULL,
