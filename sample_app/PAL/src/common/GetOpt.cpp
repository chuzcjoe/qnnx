...
static const struct Option *findOpt(const string str, const struct Option *longopts,
                                    int *longindex) {
...
int getOptLongOnly(int argc, const char *const argv[], const char *, const struct Option *longopts,
                   int *longindex) {
