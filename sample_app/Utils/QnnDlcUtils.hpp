 ...
 */
StatusCode createDlcHandle(const QnnSystemInterface_t& systemInterface, const std::string& dlcPath,
                           QnnLog_Callback_t logCallback, QnnLog_Level_t logLevel,
                           Qnn_LogHandle_t& logHandle, QnnSystemDlc_Handle_t& dlcHandle);
 ...
 */
void freeDlcResources(const QnnSystemInterface_t& systemInterface, QnnSystemDlc_Handle_t& dlcHandle,
...
StatusCode composeGraphsFromDlc(const QnnSystemInterface_t& systemInterface,
                                QnnSystemDlc_Handle_t dlcHandle, Qnn_BackendHandle_t backendHandle,
                                Qnn_ContextHandle_t context, const QnnInterface_t& qnnInterface,
 ...
 * @return StatusCode indicating success or failure
 */
StatusCode retrieveGraphHandles(const QnnInterface_t& qnnInterface, Qnn_ContextHandle_t context,
                                qnn_wrapper_api::GraphInfo_t** graphsInfo, uint32_t graphsCount);
