...
typedef struct dspStaticParamDescriptor {
  uint32_t size;  // including size of descriptor (including dims + data for tensors) (or including
                  // string for strings)
...
int SnpeUdo_flattenStaticParams(SnpeUdo_Param_t** paramList, uint32_t numParams,
                                uint32_t* flattenedSize, void** flattened);
