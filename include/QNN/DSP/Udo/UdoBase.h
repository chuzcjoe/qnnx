...
typedef enum {
  ...
  UDO_LAYOUT_NULL = 0x13,
  SNPE_UDO_LAYOUT_LAST = 0xFFFFFFFF,
  UDO_LAYOUT_LAST = 0xFFFFFFFF
...
typedef enum {
  ...
  SNPE_UDO_PARAMTYPE_SCALAR = 0x00,
  UDO_PARAMTYPE_SCALAR = 0x00,
  /// UDO static param type: string
  SNPE_UDO_PARAMTYPE_STRING = 0x01,
  UDO_PARAMTYPE_STRING = 0x01,
  /// UDO static param type: tensor
  SNPE_UDO_PARAMTYPE_TENSOR = 0x02,
  UDO_PARAMTYPE_TENSOR = 0x02,
  SNPE_UDO_PARAMTYPE_LAST = 0xFFFFFFFF,
  UDO_PARAMTYPE_LAST = 0xFFFFFFFF
} SnpeUdo_ParamType_t;
...
typedef enum {
  ...
  SNPE_UDO_QUANTIZATION_NONE = 0x00,
  UDO_QUANTIZATION_NONE = 0x00,
  /// Tensor Quantization type: Tensorflow-style
  SNPE_UDO_QUANTIZATION_TF = 0x01,
  UDO_QUANTIZATION_TF = 0x01,
  SNPE_UDO_QUANTIZATION_QMN = 0x02,
  UDO_QUANTIZATION_QMN = 0x02,
  SNPE_UDO_QUANTIZATION_LAST = 0xFFFFFFFF,
  UDO_QUANTIZATION_LAST = 0xFFFFFFFF
...
/**
 * @brief A struct which defines the quantization parameters in case of Tensorflow style
 * quantization
 *
 */
typedef struct {
