...
#define EXPAND_LAST_32(SIZE, STR) \
  EXPAND_LAST_16((SIZE - 0x10), STR), EXPAND_LAST_16((SIZE - 0x00), STR)

#if 0
/* If we need bigger file names... */
#define EXPAND_LAST_64(SIZE, STR)                                         \
  EXPAND_LAST_16((SIZE - 0x30), STR), EXPAND_LAST_16((SIZE - 0x20), STR), \
      EXPAND_LAST_16((SIZE - 0x10), STR), EXPAND_LAST_16((SIZE - 0x00), STR)
#endif
...
template <int line, char... file_chars>
