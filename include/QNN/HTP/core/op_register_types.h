...
[[gnu::always_inline]] constexpr op_reg_parms op_reg_parms::parms_for() {
  return op_reg_parms {
    ...
    Derived::create, &typeid(Derived),
        ...
        test_flag_for(flags_for<Derived, N>, Flags::IS_CONST)
            ? nullptr
            : alloc_func_for_op<Derived>::alloc_func,
        !std::is_trivially_destructible<Derived>::value ? dealloc_func_for_op<Derived>::func
                                                        : nullptr,
#endif
#ifndef PREPARE_DISABLED
