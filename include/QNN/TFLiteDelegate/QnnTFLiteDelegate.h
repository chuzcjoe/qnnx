...
QNN_DELEGATE_CAPI_EXPORT TfLiteQnnDelegateOptions TfLiteQnnDelegateOptionsDefault();
...
///
/// Note that this is an experimental feature.
QNN_DELEGATE_CAPI_EXPORT void* TfLiteQnnDelegateAllocCustomMem(size_t bytes, size_t alignment);
...
QNN_DELEGATE_CAPI_EXPORT void TfLiteQnnDelegateClearProfilingResult(TfLiteDelegate* delegate);
